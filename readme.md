...
> [!WARNING]
> This is the **legacy branch** maintained for older Acode versions.
>
...
- ⚡ **Instant snippet expansion** — type `|` then `Enter`
...
2. Type `|`
3. Press `Enter`
4. **Choose your color** from the dropdown
5. **Choose your mode** — Dark or Light
6. `:root` snippet appears instantly ✅
...
- This is the **Legacy** branch maintained for older Acode releases.
- If you're using Acode **v1.12.6+**, please switch to the **main** branch.
- Works on **`.css` files only**.
- Compatible with Acode **v1.8.0 - v1.12.6** (`minVersionCode: 290 - 1001`).
